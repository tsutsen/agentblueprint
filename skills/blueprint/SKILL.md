...
| 4 | `data`         | Data             | `skills/blueprint/schemas/markdown/Data.md`         | `artifacts/GoalSpec.json`, `artifacts/ArchitectureSpec.json`                                              | `artifacts/Data.md` + `artifacts/Data.json`              |
| 5 | `api`          | Api              | `skills/blueprint/schemas/markdown/Api.md`          | `artifacts/GoalSpec.json`, `artifacts/ArchitectureSpec.json`, `artifacts/Data.json`                   | `artifacts/Api.md` + `artifacts/Api.json`   |
| 6 | `test`         | Test             | `skills/blueprint/schemas/markdown/Test.md`         | `artifacts/GoalSpec.json`, `artifacts/Api.json`, `artifacts/Data.json`                            | `artifacts/Test.md` + `artifacts/Test.json` |
| 7 | `plan`         | TaskPlan         | `skills/blueprint/schemas/markdown/TaskPlan.md`         | `artifacts/GoalSpec.json`, `artifacts/DesignSpec.json`, `artifacts/ArchitectureSpec.json`, `artifacts/Data.json`, `artifacts/Api.json`, `artifacts/Test.json` | `tasks/PLAN.md` + `tasks/epics/` |
