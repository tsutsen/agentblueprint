...
export function DetailPanel({ node, connections, onClose, onSelectNode }: DetailPanelProps) {
  return (
    <div data-testid="detail-panel" className="absolute top-4 right-4 w-[360px] max-h-[calc(100%-2rem)] bg-card border border-border rounded-xl shadow-lg z-40 flex flex-col overflow-hidden animate-in fade-in zoom-in-95 slide-in-from-right-4 slide-in-from-top-2 duration-100">
      {/* Header */}
