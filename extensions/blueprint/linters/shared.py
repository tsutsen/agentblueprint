...
dispatch live in rules.py. Completeness gate handlers live in gates.py.

Shared check functions (used by both rules and gates) are defined below.
Completeness gates and assessors are also defined below for suite-level use.
